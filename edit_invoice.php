				...
				<div class="load-animate animated fadeInUp">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
							...
							<div class="form-group">
								<input value="<?php echo $invoiceValues['numero_facture']; ?>" type="text" class="form-control" name="Numero_Facture" id="Numero_Facture" placeholder="Numero De la Facture" autocomplete="off">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<input value="<?php echo $invoiceValues['order_reveiver_phone']; ?>" type="text" class="form-control" name="companyPhone" id="companyName" placeholder="Company Name" autocomplete="off">
							</div>
							<div class="form-group">
								<textarea class="form-control" rows="3" name="address" id="address" placeholder="Your Address">
									<?php echo
					...
					<div class="row mt-3 mb-3">
						<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
							...
							<button class="btn btn-success border-0" id="addRows" type="button">+ Ajouter </button>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input value="<?php echo $invoiceValues['order_tax_per']; ?>" type="number" class="form-control" name="taxRate" id="taxRate" placeholder="Taux TVA">
								</div>
							</div>
						</div>
						<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
							<div class="form-group">
								...
								<div class="input-group">
									<div class="input-group-append currency"><span class="input-group-text">FCFA</span></div>
									<input value="<?php echo $invoiceValues['order_total_tax']; ?>" type="number" class="form-control" name="taxAmount" id="taxAmount" placeholder="Montant TVA">
								</div>
							</div>
						</div>
						<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
						...
						<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
							...
							<div class="form-group">
								...
								<input data-loading-text="Mise a jour..." type="submit" name="invoice_btn" value="Sauvegarder" class="btn btn-success submit_btn invoice-save-btm">
							</div>
